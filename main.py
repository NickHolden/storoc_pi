...
# This code is based off the EdjeElectronics TensorFlow Object Detection:
...
# We are using this custom class for optimization purposes
...
while True:
    ...
    for i in range(len(scores)):
        if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
            ...
            # Get name of object detected
            object_name = labels[int(classes[i])]  # Look up object name from "labels" array using class index


            # Make sure that the object detected is a person
